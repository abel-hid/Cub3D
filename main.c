...
// void draw_walls(t_win *win, t_map *map)
// {
//     int x;
...
//     while (x < WIDTH)
//     {
//         // Calculate ray direction, perform DDA, and get wall height


//         double cameraX = 2 * x / (double)WIDTH - 1;
//         double rayDirX = map->player.dirX + map->player.planeX * cameraX;
//         double rayDirY = map->player.dirY + map->player.planeY * cameraX;

//         // Implement DDA algorithm and calculate wall height

//         // Draw the wall at the current column
//         int wallHeight = /* calculate wall height based on DDA result */;
//         int wallColor = /* choose color or texture based on the map data */;
//         int drawStart = /* calculate starting point for drawing the wall */;
//         int drawEnd = /* calculate ending point for drawing the wall */;

//         int y = drawStart;
//         while (y < drawEnd)
//         {
//             mlx_put_pixel(win->img, x, y, wallColor);
//             y++;
//         }
